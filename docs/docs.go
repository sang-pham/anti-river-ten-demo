...
const docTemplate = `{
            ...
            "get": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        "minimum": 1,
                        "type": "integer",
                        "description": "Maximum number of queries to analyze (default: 5)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
        ...
        "/v1/sql-logs/report": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Comma separated percentiles in 0..100. Default 50,75,90,95,99",
                        "name": "pcts",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "Top query patterns count. Default 20, min 1, max 200",
                        "name": "top_patterns",
                        "in": "query"
                    }
                ],
        ...
        "/v1/sql-logs/scan": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Database name to filter results",
                        "name": "dbName",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "default": 500,
                        "description": "Minimum exec_time_ms to be considered abnormal",
                        "name": "exec_time_ms",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "default": 100,
                        "description": "Minimum exec_count to be considered abnormal",
                        "name": "exec_count",
                        "in": "query"
                    }
                ],
    ...
    "definitions": {
        ...
        "sqllog.Percentiles": {
            ...
            "properties": {
                "exec_count": {
                    "$ref": "#/definitions/sqllog.PercentileSet"
                },
                "exec_time_ms": {
                    "$ref": "#/definitions/sqllog.PercentileSet"
                }
        ...
        "sqllog.ReportData": {
            ...
            "properties": {
                ...
                "percentiles_by_db": {
                    "type": "object",
                    "additionalProperties": {
                        "$ref": "#/definitions/sqllog.Percentiles"
                    }
                },
                "percentiles_overall": {
                ...
                "top_patterns_by_db": {
                    ...
                    "additionalProperties": {
                        "type": "array",
                        "items": {
                            "$ref": "#/definitions/sqllog.PatternStat"
                        }
                    }
                },
